...
{
    public class PeliculaForUpdate
    {

        [Required( ErrorMessage = "Titulo is required" )]
        [StringLength( 60, ErrorMessage = "Titulo can't be longer than 200 characters" )]
        public string Titulo { get; set; } = null!;

        [Required( ErrorMessage = "Descripcion is required" )]
        [StringLength( 60, ErrorMessage = "Descripcion can't be longer than 255 characters" )]
